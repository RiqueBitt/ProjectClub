...
const GROUPS = [
  { label: 'GERAL', keys: ['ADMINISTRATOR', 'MANAGE_COMMUNITY', 'MANAGE_ROLES', 'MANAGE_CHANNELS', 'MANAGE_EMOJIS', 'MANAGE_STICKERS', 'KICK_MEMBERS', 'BAN_MEMBERS', 'MODERATE_MEMBERS', 'CHANGE_NICKNAME', 'MANAGE_NICKNAMES', 'VIEW_AUDIT_LOG'] },
