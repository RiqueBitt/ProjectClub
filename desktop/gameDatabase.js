...
const GAMES = [
  ...
  { name: 'Minecraft', steamAppId: null, process: { win: 'javaw.exe', linux: 'minecraft-launcher' } },
  { name: 'Valorant', steamAppId: null, process: { win: 'VALORANT-Win64-Shipping.exe' } },
  { name: 'League of Legends', steamAppId: null, process: { win: 'League of Legends.exe' } },
  { name: 'Fortnite', steamAppId: null, process: { win: 'FortniteClient-Win64-Shipping.exe' } },
  ...
  { name: 'Roblox', steamAppId: null, process: { win: 'RobloxPlayerBeta.exe' } },
